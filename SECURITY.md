...
FileZ moves files in folders you chose. A real vulnerability here is anything that would make
...
- **The source-site rule** — FileZ reads the download's origin from the Zone.Identifier
...
[issue tracker](https://github.com/nur-arpon/FileZ/issues) for those.

## Reporting a vulnerability

**Please do not open a public issue for a security problem.** Report it privately:

1. Go to the [Security tab](https://github.com/nur-arpon/FileZ/security) of this repository.
